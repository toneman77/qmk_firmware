...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DEF] = {
        ...
        {TABDUAL,  KC_Q,    KC_W,    KC_E,    KC_R,     KC_T,   KC_Y,    KC_U,      KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, ENTERDUAL },
        {CAPSDUAL, KC_A,    KC_S,    KC_D,    KC_F,     KC_G,   KC_H,    KC_J,      KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_NUHS, _______   },
        {KC_LSFT,  KC_NUBS, KC_Z,    KC_X,    KC_C,     KC_V,   KC_B,    KC_N,      KC_M,    KC_COMM, KC_DOT,  KC_SLSH, ARRUP,   TG(_SFX)  },
        {KC_LCTL,  KC_LGUI, KC_LALT, _______, _______, _______, _______, SPACEDUAL, _______, _______, KC_RALT, ARRLEFT, ARRDOWN, ARRRIGHT  }
    },
