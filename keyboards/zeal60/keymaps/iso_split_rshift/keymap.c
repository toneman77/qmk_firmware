...
// dual-role shortcuts
#define DL_TAB   LT(_TAB, KC_TAB)
#define DL_CAPS  CTL_T(KC_ESC)
#define DL_SPACE LT(_SPC, KC_SPACE)
#define DL_ENTER CTL_T(KC_ENT)
#define DL_SCLN  CTL_T(KC_SCLN)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DEF] = {
        ...
        {DL_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,     KC_T,   KC_Y,    KC_U,      KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, DL_ENTER  },
        {DL_CAPS,  KC_A,    KC_S,    KC_D,    KC_F,     KC_G,   KC_H,    KC_J,      KC_K,    KC_L,    DL_SCLN, KC_QUOT, KC_NUHS, _______   },
        {KC_LSFT,  KC_NUBS, KC_Z,    KC_X,    KC_C,     KC_V,   KC_B,    KC_N,      KC_M,    KC_COMM, KC_DOT,  KC_SLSH, ARRUP,   TG(_SFX)  },
        {KC_LCTL,  KC_LGUI, KC_LALT, _______, _______, _______, _______, DL_SPACE,  _______, _______, KC_RALT, ARRLEFT, ARRDOWN, ARRRIGHT  }
    },
    ...
    [_SPC] = {
        ...
        {_______, KC_PAUS, KC_UP,   GER_BRC_L, GER_BRC_R, _______,   _______,  GER_PAR_L, GER_PAR_R, _______, _______, _______, _______, KC_MPLY }, 
        {_______, KC_LEFT, KC_DOWN, KC_RIGHT,  _______,   _______,   KC_LEFT,  KC_DOWN,   KC_UP,     KC_RGHT, _______, _______, _______, _______ }, 
    ...
    [_TAB] = {
        ...
        {_______, _______, _______, _______, _______, _______, _______, GER_CUR_L, GER_CUR_R, _______, _______, _______, _______, KC_ENT  },
    ...
    [_SFX] = {
        ...
        {_______, _______, _______, _______, _______, _______, _______, KC_4,    KC_5,    KC_6,    _______, _______, _______, KC_ENT  },
        {_______, EF_INC,  EF_DEC,  BR_INC,  BR_DEC,  _______, _______, KC_1,    KC_2,    KC_3,    _______, _______, XXXXXXX, KC_BSLS },
        {_______, H1_INC,  H1_DEC,  H2_INC,  H2_DEC,  S1_INC,  S1_DEC,  S2_INC,  S2_DEC,  KC_0,    _______, KC_SLSH, KC_UP,   _______ },
